...
import CopilotAccountRow from './copilot_account_table';

/** Type-only namespace exports for generated type groups. */

/** The schema information for all tables in this module. This is defined the same was as the tables would have been defined in the server. */
const tablesSchema = __schema({
  // NOTE: The key MUST match the wire table name the SpacetimeDB server sends
  // in WebSocket messages. The SDK uses this key as `sourceName` for lookups.
  // If this key is camelCase (e.g. copilotAccount) but the server sends
  // snake_case (copilot_account), the SDK will crash with:
  //   "Cannot read properties of undefined (reading 'columns')"
  copilot_account: __table(
    {
      name: 'copilot_account',
      indexes: [{ name: 'id', algorithm: 'btree', columns: ['id'] }],
      constraints: [
        {
          name: 'copilot_account_id_key',
          constraint: 'unique',
          columns: ['id'],
        },
      ],
...
const reducersSchema = __reducers(
  __reducerSchema('add_account', AddAccountReducer),
  __reducerSchema('refresh_account', RefreshAccountReducer),
  __reducerSchema('remove_account', RemoveAccountReducer)
);
